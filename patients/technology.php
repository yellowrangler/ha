...
<br /><br />
<span style="font-variant:small-caps;color:<?php print $patientColor; ?>">The Healthcare Problem</span>
&nbsp; - &nbsp; 
<span style="font-variant:small-caps;color:<?php print $patientColor; ?>">Fragmentation of Patient Information</span>
<br />
...
<br /><br />
<span style="font-variant:small-caps;color:<?php print $patientColor; ?>">The Health Allianze Solution</span>
<br />
...
<a href="#" id="playVideo"><img border="0" title="Click on this image to see the video!" src="/ha/images/patientfragmentation.png"></a></center>
